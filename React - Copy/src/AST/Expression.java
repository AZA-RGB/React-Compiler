...
public class Expression extends ASTNode  {
	...
	public String toJS() {
        ...
        if (exp.leftExpression!=null) expressionCode.append(exp.leftExpression.toJS());
        if(exp.operator!=null) expressionCode.append(operator.toJS());
        if (exp.rightExpression!=null)    expressionCode.append(exp.rightExpression.toJS());
